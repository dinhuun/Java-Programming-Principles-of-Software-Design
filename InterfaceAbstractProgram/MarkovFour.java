 ...
 * randomly picking a follow from a list of follows of a lead of length 4 from a training text
...
public class MarkovFour extends AbstractMarkovModel {
    ...
    public String getRandomText(int numChars) {
        ...
        int indexStart = myRandom.nextInt(trainingText.length() - 4);
        String lead = trainingText.substring(indexStart, indexStart + 4);
        sb.append(lead);
